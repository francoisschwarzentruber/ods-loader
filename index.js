...
/**
* read the ODS file and returns a promise on the data  { content: array of the content, style:array of the background color };
*/
function odsLoad(filename) {
